...
class Cursor
  ...
  #depending on key it will return @cursor_pos in the case of return or space
  #call the update_pos with the move difference from MOVES and return nil in the case of [up left right down]
